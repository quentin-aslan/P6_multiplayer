...
class Map {
     ...
     */
    constructor(playersArgs, io, nbBox = 100, nbWall = 20, maxWeapons = 4) {
        this.io = io;
        this.setNbBox(nbBox)
    ...
    displayImg(boxId, img) {
        ...
        this.io.emit('displayImg', {boxId, img});
        return null;
    }

    displayClearBox(boxId) {

        this.io.emit('displayClearBox', boxId);
    ...
    displayColor(boxId) {
        this.io.emit('displayColor', boxId);
        return null;
    }
